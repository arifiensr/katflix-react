          ...
          <div className="card bg-dark" data-bs-toggle="modal" data-bs-target="#secondCardModal">
            ...
            <div className="details">
              ...
              <div className="cast">
                ...
                <ul>
                  <li>
                    <img src="https://resizing.flixster.com/woH_AaFhGiLYNeRP8txdMC3BFZ4=/100x120/v2/https://flxt.tmsimg.com/assets/71705_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/abOEAjjYRkyvDAurC6bMJn7yuVc=/100x120/v2/https://flxt.tmsimg.com/assets/785124_v9_bc.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/LrxrlRx_ONJwIsrxIcD9h3Ns_AI=/100x120/v2/https://flxt.tmsimg.com/assets/566394_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/_vOWg_KJhmT47NE4PdxlQc1fDfg=/100x120/v2/https://flxt.tmsimg.com/assets/493673_v9_bc.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/r52x4GX7s2nog-nxDKbrSNvGgQs=/100x120/v2/https://flxt.tmsimg.com/assets/81158_v9_bb.jpg" alt="" />
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="modal-body d-flex align-items-start">
                  ...
                  <div className="modal-desc">
                    ...
                    <div className="cast-trailer">
                      ...
                      <div className="btn-modal">
                        <button type="button" className="modal-button modal-button-1" onClick={() => window.open('https://www.youtube.com/watch?v=nWiQodhMvz4')}>
                          Watch Trailer
                        </button>
                        <button type="button" className="modal-button modal-button-2">
                          Watch Now!
          ...
          <div className="card bg-dark" data-bs-toggle="modal" data-bs-target="#thirdCardModal">
            ...
            <div className="details">
              ...
              <div className="cast">
                ...
                <ul>
                  <li>
                    <img src="https://resizing.flixster.com/OMwb6yZXKNAdV1chaDVbjpX23gY=/100x120/v2/https://flxt.tmsimg.com/assets/218027_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/9dzDy_YPVGFeEmXI1AM5zC3dgig=/100x120/v2/https://flxt.tmsimg.com/assets/194024_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/2T-jtfm6BgiDv7C9Bn1CLDHoPeE=/100x120/v2/https://flxt.tmsimg.com/assets/1898_v9_bc.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/o_0cQ3_e4ZkG5HBGf_GFhh-v5aA=/100x120/v2/https://flxt.tmsimg.com/assets/73978_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/kUxTVLOtJDkjSpEmiSLyRR2Xylk=/100x120/v2/https://flxt.tmsimg.com/assets/151910_v9_bc.jpg" alt="" />
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="modal-body d-flex align-items-start">
                  ...
                  <div className="modal-desc">
                    ...
                    <div className="cast-trailer">
                      ...
                      <div className="btn-modal">
                        <button type="button" className="modal-button modal-button-1" onClick={() => window.open('https://www.youtube.com/watch?v=d9MyW72ELq0')}>
                          Watch Trailer
                        </button>
                        <button type="button" className="modal-button modal-button-2">
                          Watch Now!
          ...
          <div className="card bg-dark" data-bs-toggle="modal" data-bs-target="#fourthCardModal">
            ...
            <div className="details">
              ...
              <div className="cast">
                ...
                <ul>
                  <li>
                    <img src="https://resizing.flixster.com/juGCmzZ4gxhPo6MCBVpwARzmsk8=/100x120/v2/https://flxt.tmsimg.com/assets/5885_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/U0O4AjPm_a1XucMoJkQyXNh7eyQ=/100x120/v2/https://flxt.tmsimg.com/assets/71233_v9_bc.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/nKi20bZlVRDUsjdocU08f9b-_N8=/100x120/v2/https://flxt.tmsimg.com/assets/449885_v9_bd.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/4qWXe1ZYNZf-GKya28gdN8Vlcm8=/100x120/v2/https://flxt.tmsimg.com/assets/516817_v9_bd.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/HC8D04MpHlw1y9ePv4oWiHXsRpU=/100x120/v2/https://flxt.tmsimg.com/assets/1053891_v9_ba.jpg" alt="" />
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="modal-body d-flex align-items-start">
                  ...
                  <div className="modal-desc">
                    ...
                    <div className="cast-trailer">
                      ...
                      <div className="btn-modal">
                        <button type="button" className="modal-button modal-button-1" onClick={() => window.open('https://www.youtube.com/watch?v=RqrXhwS33yc')}>
                          Watch Trailer
                        </button>
                        <button type="button" className="modal-button modal-button-2">
                          Watch Now!
          ...
          <div className="card bg-dark" data-bs-toggle="modal" data-bs-target="#fifthCardModal">
            ...
            <div className="details">
              ...
              <div className="cast">
                ...
                <ul>
                  <li>
                    <img src="https://resizing.flixster.com/9wUV9Ujaga3hCwqVwL3M53l51C0=/100x120/v2/https://flxt.tmsimg.com/assets/272823_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/eQz-piPYeekQeFvguYgbW8IS5UA=/100x120/v2/https://flxt.tmsimg.com/assets/74573_v9_bc.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/SHhdGjdiYEUspWylTwZSZbBlArM=/100x120/v2/https://flxt.tmsimg.com/assets/151593_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/nvIjZslc_gFPwhJzaQ0DFyY7hN4=/100x120/v2/https://flxt.tmsimg.com/assets/797733_v9_bb.jpg" alt="" />
                  </li>
                  <li>
                    <img src="https://resizing.flixster.com/lPpfbp-HU732tn1KG13SQxNGt14=/100x120/v2/https://flxt.tmsimg.com/assets/1306025_v9_aa.jpg" alt="" />
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="modal-body d-flex align-items-start">
                  ...
                  <div className="modal-desc">
                    ...
                    <div className="cast-trailer">
                      ...
                      <div className="btn-modal">
                        <button type="button" className="modal-button modal-button-1" onClick={() => window.open('https://www.youtube.com/watch?v=AIc671o9yCI')}>
                          Watch Trailer
                        </button>
                        <button type="button" className="modal-button modal-button-2">
                          Watch Now!
